...
return [
    'main_description' => [
        'title' => 'Bartos György',
        'content' => 'Villanyszerelőként már évek óta szolgálom Csíkszereda lakóinak elektronikus szükségleteit. Az elkötelezett csapatunk mindig készen áll arra, hogy segítsen az elektromos rendszerek tervezésében, telepítésében és karbantartásában. Legyen szó egy egyszerű kis javításról vagy egy teljes villamosrendszerek tervezéséről és kiépítéséről, itt vagyunk, hogy Önnek segítsünk.',
        'button_content' => 'időpontkérés',
    ],
    'carousel' => [
        'slide1' => [
            'title' => 'Villanyszerelés',
            'content' => 'Megbízható és biztonságos megoldások!',
        ],
        'slide2' => [
            'title' => 'Napelemek',
            'content' => 'Hatékony és fenntartható napelemes rendszerek!',
        ],
        'slide3' => [
            'title' => 'Automatizálás',
            'content' => 'Okos megoldások a mindennapokban!',
        ],
    ],
    'skew_carousel' => [
        'sections' => [
    ...
    'contact_form' => [
        ...
        'subtitle' => 'Írja meg megrendelését az üzenőmezőbe',
        'name' => [
            'placeholder' => 'Név',
        ],
        'email' => [
